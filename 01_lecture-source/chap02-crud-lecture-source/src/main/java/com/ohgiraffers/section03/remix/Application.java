...
public class Application {
        ...
        do {
            ...
            switch (no) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    menuController.removeMenu(inputDeleteMenu());
                    break;
                default :
    ...
    private static Map<String, String> inputDeleteMenu() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("삭제할 메뉴 코두 입력해");
    ...
    private static Map<String, String> inputMenuCode() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.println("메뉴 코드 입력하세요");
        String menuCode = sc.nextLine();
    ...
    private static Map<String, String> inputMenu() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.println("메뉴의 이름을 입력해 : ");
        String menuName = sc.nextLine();
        System.out.println("메뉴의 가격을 입력해 : ");
        String menuPrice = sc.nextLine();
        System.out.println("카테고리 코두 입력해");
    ...
    private static Map<String, String> inputModifyMenu() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("수정할 메뉴 코두 입력해");
        String menuCode = sc.nextLine();
        System.out.print("수정할 메뉴 이름");
        String menuName = sc.nextLine();
        System.out.print("수정할 가격을 입력해 : ");
        String menuPrice = sc.nextLine();
